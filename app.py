...
# ── Navigation ────────────────────────────────────────────────────────────
doc_page = st.Page("pages/0_documentation.py", title="Documentation / Aide",
                   icon="📄")
...
now_page = st.Page("pages/3_nowcast.py", title="Module 3 — Nowcast",
                   icon="🔮")
cemac_page = st.Page("pages/4_cemac.py", title="Module 4 — CEMAC Agrégé",
                     icon="🌍")
rap_page = st.Page("pages/5_rapports.py", title="Module 5 — Rapports",
                   icon="📋")

nav = st.navigation([doc_page, icae_page, prev_page, now_page,
                      cemac_page, rap_page])
nav.run()
